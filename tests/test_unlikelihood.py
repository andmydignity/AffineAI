...
def test_unlikelihood_off_by_default():
    cfg = TorosHybridConfig(dim=64, d_byte=32, n_encoder_layers=2, n_heads=2, target_patch_size=8, use_rls_heads=False, use_type_codebook=False, dynamic_patching=False, use_growth=False)
