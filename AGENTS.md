...
- `affine_ai/models/` — `language_model.py` (ASDAG LM, default `channel_mixer_type="asdag_tree"`), `blt.py`, `hybrid.py` (stripped: patch encoder + BLT decoder, no JEPA), `jepa.py` (`TorosJEPA` — deprecated), `mtp.py`.
